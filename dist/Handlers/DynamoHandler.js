...
var RestfulHandler_1 = require("./RestfulHandler");
...
var DynamoHandler = (function (_super) {
    ...
    DynamoHandler.prototype.formatSearchResult = function (results) {
        ...
        var promises = results.Items.map(function (item) { return _this.formatResult(item); });
    ...
    DynamoHandler.prototype.create = function () {
        ...
        return this.getSingleKey(true).then(function (key) {
            ...
            var params = {
                TableName: _this.table,
                Item: data,
                ConditionExpression: _this.creationConditionExpression()
            };
            ...
            if (error.code == 'ConditionalCheckFailedException') {
                return Promise.reject(new Errors_1.BadRequestError());
            }
            else {
    ...
    DynamoHandler.prototype.update = function () {
        ...
        return this.getSingleKey().then(function (itemKey) {
            ...
            var params = {
                TableName: _this.table,
                Item: data,
                ConditionExpression: _this.updateConditionExpression()
            };
            return _this.getDocumentClient().put(params).promise();
        }).then(function (response) {
            // Send the new item back to the client
     ...
     * @return {string}
     */
    DynamoHandler.prototype.creationConditionExpression = function () {
     ...
     * @return {string}
     */
    DynamoHandler.prototype.updateConditionExpression = function () {
...
}(RestfulHandler_1.RestfulHandler));
