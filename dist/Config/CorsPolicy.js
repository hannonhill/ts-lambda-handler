...
var CorsPolicy = (function () {
    ...
    CorsPolicy.prototype.headers = function (request) {
        var headers = {};
        headers['Access-Control-Allow-Origin'] = this.allowedOrigins(request.getOriginDomain(), request.getOriginProtocol(), request.getOriginPort());
     ...
     * @return {string}
     */
    CorsPolicy.prototype.allowedOrigins = function (originHost, originProtocol, originPort) {
        if (originPort === void 0) { originPort = ''; }
